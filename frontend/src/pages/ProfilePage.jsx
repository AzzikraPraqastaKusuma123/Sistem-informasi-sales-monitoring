      ...
      <div className="profile-card">
        <div className="profile-header">
          {profile.profile_picture_url ? (
            <img
              src={`${import.meta.env.VITE_API_BASE_URL.endsWith('/') ? import.meta.env.VITE_API_BASE_URL : `${import.meta.env.VITE_API_BASE_URL}/`}${profile.profile_picture_url.startsWith('/') ? profile.profile_picture_url.substring(1) : profile.profile_picture_url}`}
              alt={profile.name}
